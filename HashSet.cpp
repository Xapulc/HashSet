...
HashSet::L1ListLinker* HashSet::search(const HashSetKey* key) const {
    int h = hashIndex(key);
    L1ListLinker* p = &(hashTable[h]); // The head of the chain with index h
